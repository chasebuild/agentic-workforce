...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::task::TaskComplexity::decl(),
        ...
        db::models::agent_skill::UpdateAgentSkill::decl(),
        db::models::agent_profile::AgentProfile::decl(),
        db::models::agent_profile::AgentProfileWithSkills::decl(),
        db::models::agent_profile::AgentProfileSkill::decl(),
        db::models::agent_profile::CreateAgentProfile::decl(),
        db::models::agent_profile::SkillAssignment::decl(),
        db::models::agent_profile::UpdateAgentProfile::decl(),
        db::models::swarm_execution::SwarmExecutionStatus::decl(),
        db::models::swarm_execution::SwarmExecution::decl(),
        db::models::swarm_execution::CreateSwarmExecution::decl(),
        db::models::swarm_execution::UpdateSwarmExecution::decl(),
        db::models::swarm_execution::SwarmPlanOutput::decl(),
        db::models::swarm_execution::PlannedSubtask::decl(),
        db::models::swarm_task::SwarmTaskStatus::decl(),
        db::models::swarm_task::SwarmTask::decl(),
        db::models::swarm_task::CreateSwarmTask::decl(),
        db::models::swarm_task::SwarmTaskWithDetails::decl(),
        db::models::swarm_task::SwarmProgress::decl(),
        db::models::consensus_review::ConsensusVote::decl(),
        db::models::consensus_review::ConsensusReview::decl(),
        db::models::consensus_review::CreateConsensusReview::decl(),
        db::models::consensus_review::SubmitReviewVote::decl(),
        db::models::consensus_review::ConsensusReviewWithProfile::decl(),
        db::models::consensus_review::ConsensusSummary::decl(),
